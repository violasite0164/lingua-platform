...
import { BookOpen, FileQuestion, Users, Video } from 'lucide-react';
...
export default async function MentorDashboardPage() {
  ...
  const tiles = [
    ...
    {
      label: '測驗管理',
      value: stats.totalCourseQuizzes,
      icon: FileQuestion,
      hint:
        stats.draftCourseQuizzes > 0
          ? `共 ${stats.totalCourseQuizzes} 個 · ${stats.draftCourseQuizzes} 個草稿`
          : '已建立的測驗總數',
