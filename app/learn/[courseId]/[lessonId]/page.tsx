...
import { canAccessLessonInCourse, hasLessonWatchAccess } from '@/lib/course-quiz/access';
import {
...
export default async function LearnLessonPage({
  ...
  if (!hasLessonWatchAccess(lesson, course)) {
    redirect(`/courses/${courseId}`);
  }

  if (!canAccessLessonInCourse(course, lessonId)) {
