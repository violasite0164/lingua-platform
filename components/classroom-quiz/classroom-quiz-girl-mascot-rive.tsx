...
import {
  CLASSROOM_QUIZ_MASCOT_GIRL_RIVE_SRC,
  CLASSROOM_QUIZ_MASCOT_GIRL_SRC,
...
export const ClassroomQuizGirlMascotRive = forwardRef<HTMLDivElement, Props>(
  function ClassroomQuizGirlMascotRive({ mood, className }, ref) {
    ...
    const { rive, RiveComponent } = useRive(
      {
        src: CLASSROOM_QUIZ_MASCOT_GIRL_RIVE_SRC,
    ...
    if (usePngFallback || reducedMotion) {
      return (
        ...
        >
          ...
          <img
            src={CLASSROOM_QUIZ_MASCOT_GIRL_SRC}
            alt=""
            width={220}
            height={320}
