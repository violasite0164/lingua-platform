...
import { QUIZ_MASCOT_BOY_RIVE_SRC, QUIZ_MASCOT_BOY_SRC } from '@/lib/games/registry';
...
/**
 * 答題場景男孩吉祥物：優先 Rive（boy1_idle），失敗時回退 PNG。
 */
export const QuizBoyMascotRive = forwardRef<HTMLDivElement, Props>(function QuizBoyMascotRive(
  { mood, className },
  ref,
) {
