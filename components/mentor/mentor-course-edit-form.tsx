...
import { SubscriptionAccessFields } from '@/components/mentor/subscription-access-fields';
...
export function MentorCourseEditForm({
  course,
  lessons,
  categories,
  planLabels,
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <SubscriptionAccessFields
              mode="course"
              courseBasic={course.sub_basic_free}
              coursePro={course.sub_pro_free}
          ...
          <div className="space-y-6">
            {lessons.map((lesson) => (
              <LessonEditorCard
                ...
                lesson={lesson}
                courseId={course.id}
                courseSubBasic={course.sub_basic_free}
                courseSubPro={course.sub_pro_free}
                planLabels={planLabels}
              />
            ))}
          </div>
