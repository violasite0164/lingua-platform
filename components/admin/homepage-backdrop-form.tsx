...
export function HomepageBackdropForm({ initial }: Props) {
  ...
  const backgroundImageFileRefs = useRef<Array<HTMLInputElement | null>>([]);
  ...
  const teachersCardFileRefs = useRef<Array<HTMLInputElement | null>>([]);
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- initial object can be recreated; watch DB fields only
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                <input
                  ref={(node) => {
                    backgroundImageFileRefs.current[slotIndex] = node;
                  }}
                  type="file"
                ...
                <Button
                  ...
                  onClick={() => backgroundImageFileRefs.current[slotIndex]?.click()}
                >
                  {uploading === uploadKey ? (
                    <>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                <input
                  ref={(node) => {
                    teachersCardFileRefs.current[cardIndex] = node;
                  }}
                  type="file"
                  accept={HOMEPAGE_IMAGE_ACCEPT}
                  className="sr-only"
                ...
                <Button
                  ...
                  disabled={uploading !== null}
                  className="border-zinc-600 bg-zinc-900 text-zinc-200 hover:bg-zinc-800"
                  onClick={() => teachersCardFileRefs.current[cardIndex]?.click()}
                >
                  {uploading === cardIndex ? (
                    <>
                      <Loader2 className="mr-2 size-4 animate-spin" />
